...
export default function InlineConsultCTA({ bookingUrl, question = "Not sure if it's the right treatment?", phone }: InlineConsultCTAProps) {
  return (
    <section className="max-w-5xl mx-auto px-6 py-4">
      <div className="bg-plum-900/5 border border-plum-900/10 rounded-2xl px-6 py-7 text-center">
        <p className="text-sm sm:text-base leading-snug max-w-xl mx-auto mb-5">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 bg-brand-600 hover:bg-brand-700 text-white text-sm font-semibold px-6 py-3 rounded-xl transition-colors"
        >
        ...
        {phone && <CallTextPills phone={phone} variant="light" className="mt-6" />}
      </div>
    </section>
  )
}
