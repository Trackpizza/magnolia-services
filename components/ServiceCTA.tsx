  ...
  return (
    <section className="bg-plum-900 py-16 mt-10">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="border border-white/15 rounded-2xl px-8 py-5 max-w-md mx-auto flex flex-col sm:flex-row items-center gap-4">
          ...
          <a
            ...
            className="shrink-0 bg-white/10 hover:bg-white/20 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-colors whitespace-nowrap flex items-center gap-2"
          >
